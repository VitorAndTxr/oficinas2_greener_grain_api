...
{
    public class OfficerHourRepository : RepositoryBase<OfficerHour>, IOfficerHourRepository
    {
        public OfficerHourRepository(IDbFactory dbFactory, IApiContext apiContext)
