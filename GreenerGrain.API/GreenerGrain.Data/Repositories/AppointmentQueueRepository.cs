...
{
    public class AppointmentQueueRepository : RepositoryBase<AppointmentQueue>, IAppointmentQueueRepository
    {
        public AppointmentQueueRepository(IDbFactory dbFactory, IApiContext apiContext)
